    ...
    <footer className="foot">
      ...
      <div className="wrap" style={{ paddingTop: "clamp(3rem,2rem+3vw,5rem)" }}>
        ...
        <div className="foot__top">
          <div>
            <Link href={link("/")} aria-label="Ethno Logistics">
          ...
          <div className="foot__col">
            <h4>{<T s={"Навигация"} />}</h4>
            <Link href={link("/#services")}>{<T s={"Услуги"} />}</Link>
            <Link href={link("/#why")}>{<T s={"Преимущества"} />}</Link>
            <Link href={link("/stores")}>{<T s={"Магазины"} />}</Link>
            <Link href={link("/how-it-works")}>{<T s={"Как это работает"} />}</Link>
            <Link href={link("/company")}>{<T s={"О компании"} />}</Link>
            <Link href={link("/contact")}>{<T s={"Контакты"} />}</Link>
            <Link href={link("/blog")}>{<T s={"Блог"} />}</Link>
          </div>
