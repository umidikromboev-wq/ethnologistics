...
export const CONTACT = {
  ...
  phoneHref: "tel:+998555202020",
  telegram: "https://t.me/Ethno_uz", // ichida ariza va kuzatuv xizmati bor rasmiy bot
  instagram: "https://instagram.com/ethno.uzbekistan",
  trackBot: "https://t.me/Ethno_uz",
...
export const BUYER_STEPS = [
  {
    n: "01",
    t: "Заявка",
    d: "Звоните или пишете — менеджер выясняет, что нужно купить и привезти.",
  },
  {
    n: "02",
    t: "Поиск товара",
    d: "Находим товар или услугу в нужной стране. Поиск бесплатный — до 3 итераций.",
  },
  {
    n: "03",
    t: "Согласование",
    d: "Показываем результат, считаем стоимость закупа и логистики, согласуем сроки.",
  },
  {
    n: "04",
    t: "Выкуп и доставка",
    d: "После предоплаты оформляем заказ и ведём вас по всем этапам до выдачи посылки.",
  },
];
...
export const ARTICLES = [
  ...
  {
    slug: "tekstil-eksport-rossiya",
    tag: "Ethno Logistics",
    title:
      "Экспорт Текстиля из Узбекистана в Россию: Логистика и Оплата — Ethno Logistics",
    excerpt:
      "Экспорт текстиля в Россию ($2.6 млрд). Сборные грузы от 100 кг, решение проблем с банковскими переводами и платежами, таможенное декларирование.",
    read: "5 мин",
    date: "Август 2026",
  },
  {
    slug: "bayor-xizmati-marketpleyslar-uchun",
    tag: "Ethno Logistics",
    title: "Баерские Услуги для Селлеров Маркетплейсов — Ethno Logistics",
    excerpt:
      "Облегчите работу вашего онлайн-магазина на 30-40%! Услуги байеров и выкупа товаров с Taobao, 1688, Trendyol для Wildberries, Uzum и Yandex Market.",
    read: "5 мин",
    date: "Август 2026",
  },
  {
    slug: "tashkent-moskva-ekspress-kargo-36-soat",
    tag: "Ethno Logistics",
    title: "Экспресс-Доставка Ташкент — Москва за 36 Часов — Ethno Logistics",
    excerpt:
      "Срочная экспресс-доставка важных документов, продуктов питания и личных посылок между Узбекистаном и Москвой за 36 часов. Надежность и скорость.",
    read: "4 мин",
    date: "Август 2026",
  },
  {
    slug: "xitoydan-tovar-import-va-biznes-yuritish",
    tag: "Ethno Logistics",
    title: "Доставка Товаров и Оборудования из Китая: Карго под Ключ — Ethno",
    excerpt:
      "Выкуп и доставка товаров, оборудования и новинок из Китая в Узбекистан. Безопасная оплата, проверка качества и низкие тарифы. Рассчитайте стоимость!",
    read: "6 мин",
    date: "Сентябрь 2026",
  },
  {
    slug: "marketpleyslar-uchun-turkiya-xitoy-kargo",
    tag: "Ethno Logistics",
    title: "Карго из Турции и Китая для Маркетплейсов — Ethno",
    excerpt:
      "Быстрое карго из Китая и Турции для Uzum, Wildberries и интернет-магазинов. Гарантированные сроки, таможня и доступные тарифы. Рассчитайте стоимость!",
    read: "5 мин",
    date: "Сентябрь 2026",
  },
  {
    slug: "limestore-dan-buyurtma-berish-qollanma",
    tag: "Ethno Logistics",
    title: "Как Заказать с Limestore: Доставка Одежды — Ethno",
    excerpt:
      "Заказ одежды с сайта Limestore.com: самая быстрая доставка за 36 часов или выгодная за 5 дней. Удобная оплата, выкуп товаров и надежное карго.",
    read: "5 мин",
    date: "Сентябрь 2026",
  },
];

// 1. MAQOLA STRUKTURASI VA METADATALARI
