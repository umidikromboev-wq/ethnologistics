...
export const metadata = {
  ...
  title: {
    default: "Доставка Грузов и Посылок из России в Узбекистан | Карго",
    template: "%s · Ethno Logistics",
  },
  description:
    "Профессиональная доставка грузов и посылок из России в Узбекистан от компании Ethnologistics. Надежные перевозки «под ключ», регулярные рейсы, выгодные тарифы и гарантия сохранности.",
  keywords: [
