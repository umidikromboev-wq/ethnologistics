      ...
      <main>
        ...
        <section className="hero-v" data-dark-hero="1">
          ...
          <div className="hero-v__wrap">
            <div className="hero-v__head">
              <h1>Доставка и выкуп товаров из <span className="accent">8 стран</span> под ключ</h1>
              <p className="hero-v__sub">
                Организуем доставку, выкуп товаров, таможенное оформление и отслеживание из России,
            ...
            <div className="hero-v__foot">
              <div className="hero-v__btns">
                <a className="btn btn--glass btn--lg" href={CONTACT.telegram}>Рассчитать стоимость в Telegram</a>
                <a className="btn btn--glass btn--lg" href="#calc">Рассчитать стоимость на сайте</a>
              </div>
              <div className="ai-card">
                <div className="ai-card__phone" aria-hidden="true">
                  <div className="ph">
                    ...
                    <div className="ph-card">
                      <div className="ph-no">Посылка ETH-48210</div>
                      <div className="ph-row"><span className="ph-st">В пути</span><span className="ph-badge">Экспресс</span></div>
                      ...
                      <div className="ph-eta">Прибудет завтра · Ташкент</div>
                    </div>
                    <div className="ph-card">
                      <div className="ph-no">Расчёт доставки</div>
                      <div className="ph-row"><span className="ph-amt">$144</span><span className="ph-eta">12 кг · Москва</span></div>
                    </div>
                  </div>
                </div>
                ...
                <div className="ai-card__title">Ваша доставка — в приложении Ethno</div>
                <div className="ai-card__list">
                  <div className="ai-card__row"><span className="ai-card__plus">+</span>Отслеживание 24/7 — приложение, бот и сайт</div>
                  <div className="ai-card__row"><span className="ai-card__plus">+</span>Расчёт стоимости за минуту</div>
                  <div className="ai-card__row"><span className="ai-card__plus">+</span>История заказов и документы под рукой</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="section geo" id="geo">
          <div className="wrap">
            <div className="geo__grid">
              <div>
                <span className="sidx" style={{ color: "#6db0e8" }}>География</span>
                <h2 style={{ marginTop: "1rem" }}>Доставляем из 8 стран в Узбекистан</h2>
                <p className="lead" style={{ marginTop: "1rem" }}>
                  Собственные склады в 8 странах и более 20 отлаженных маршрутов по миру. Принимаем груз на складе за рубежом,
                  консолидируем, оформляем таможню и доводим до двери в Узбекистане.
                </p>
                <div className="geo__stats">
                  <div className="geo__stat"><div className="n tnum">8</div><div className="l">стран и складов</div></div>
                  <div className="geo__stat"><div className="n tnum">36 ч</div><div className="l">ультра-срочно</div></div>
                  <div className="geo__stat"><div className="n tnum">с 2015</div><div className="l">на рынке</div></div>
                </div>
                <div className="geo__routes">
                  {["Москва", "Алматы", "Бишкек", "Душанбе", "Стамбул", "Дубай", "Гуанчжоу"].map((r) => (
                    <span key={r} className="geo__route">{r} → Ташкент</span>
                  ))}
                </div>
              </div>
        ...
        <section className="section" id="directions">
          <div className="wrap dir-split">
            <div className="dir-aside">
              <span className="sidx">01 — Направления</span>
              <h2>Доставка из 8 стран в Узбекистан</h2>
              <p className="lead">Собственные склады в восьми странах. Везём посылки и коммерческие грузы по реальным тарифам — от выкупа в Китае до срочной авиадоставки из Турции и ОАЭ.</p>
              <a className="btn btn--primary" href="#calc" style={{ alignSelf: "start" }}>Рассчитать стоимость <IconArrow style={{ width: 18, height: 18 }} /></a>
            ...
            <div className="dir-list">
              {DIRECTIONS.map((d, i) => (
                <Reveal as={Link} key={d.slug} href={`/dostavka/${d.slug}`} className="dir-row" delay={i * 50}>
                  ...
                  <span>
                    <span className="dir-row__name">{d.name}</span>
                    <span className="dir-row__eta">{d.eta}</span>
                  </span>
                  <span className="dir-row__price">{d.price}</span>
        ...
        <section className="section" id="services">
          <div className="wrap">
            <div className="shead--edit">
              <span className="sidx">Услуги</span>
              <h2>Что и для кого мы возим</h2>
            </div>
              ...
              {SERVICES.map((s, i) => (
                <Reveal key={s.t} className="svc" delay={i * 50}>
                  ...
                  <div className="svc__body">
                    <div className="svc__name">{s.t}</div>
                    <p>{s.d}</p>
                  </div>
                </Reveal>
              ))}
        ...
        <section className="fullbleed">
          ...
          <div className="fullbleed__inner">
            <span className="eyebrow eyebrow--on-dark">Наше преимущество</span>
            <h2>Берём то, от чего отказываются другие</h2>
            <p className="lead">
              Ультра-срочная доставка за 36 часов и сложные, нестандартные грузы. За нерешаемыми
              задачами к нам обращаются даже конкуренты — и мы их закрываем.
            </p>
            <a className="btn btn--light btn--lg" href="#calc">Обсудить мой груз <IconArrow style={{ width: 18, height: 18 }} /></a>
          </div>
        </section>
        ...
        <section className="section" id="why">
          <div className="wrap">
            <div className="shead--edit">
              <span className="sidx">03 — Почему Ethno</span>
              <h2>Сильны там, где другие пасуют</h2>
            </div>
            <div className="bento">
              <div className="b-stat b-span2">
                <div className="b-ic"><IconBolt /></div>
                <div><div className="big">36 часов</div><div className="cap">Ультра-срочная доставка — возили спец-лекарства и оборудование за 6–7 часов</div></div>
              </div>
              <div className="b-stat"><div><div className="big">8</div><div className="cap">стран и собственных складов</div></div></div>
              <div className="b-stat"><div><div className="big">4.7★</div><div className="cap">173 отзыва на Яндексе</div></div></div>
              <div className="b-photo"><img src="/img/warehouse.jpg" alt="Склады Ethno" width="600" height="400" loading="lazy" /><div className="b-cap">Склады в 8 странах</div></div>
              <div className="b-feature"><div className="b-ic"><IconShield /></div><div><h3>100% ответственность</h3><p>При утрате возмещаем полную стоимость. За сохранность отвечаем целиком.</p></div></div>
              <div className="b-accent b-span2">
                <div className="b-ic" style={{ background: "rgba(255,255,255,.18)", color: "#fff" }}><IconCart /></div>
                <div><div className="big">ETHNO Buyer — выкуп под ключ</div><p>Магазин не отправляет в Узбекистан или нет зарубежной карты? Покупаем за вас, вы платите в сумах. Поиск товара бесплатный.</p></div>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="section panel" id="buyer">
          <div className="wrap grid cols-2" style={{ alignItems: "center", gap: "clamp(2rem,1rem+3vw,4rem)" }}>
            <div>
              <span className="aud__tag">ETHNO Buyer · выкуп</span>
              <h2 style={{ marginBottom: "1rem" }}>Купим товар за вас в любой стране</h2>
              <p className="lead" style={{ marginBottom: "1.4rem" }}>
                Поиск товара бесплатный — до 3 итераций. После согласования цены оформляем заказ
              ...
              <a className="btn btn--primary" href={CONTACT.telegram}>Заказать выкуп <IconArrow style={{ width: 18, height: 18 }} /></a>
            </div>
        ...
        <section className="section" id="calc">
          <div className="wrap">
            <div className="shead">
              ...
              <h2>Узнайте стоимость за минуту</h2>
              <p className="lead">Расчёт по реальным тарифам. Точную цену с учётом объёма и таможни менеджер подтвердит.</p>
            </div>
        ...
        <section className="section panel" id="business">
          <div className="wrap">
            <div className="shead--edit"><span className="sidx">04 — Кому подходит</span><h2>Для людей и для бизнеса</h2><p className="lead" style={{ maxWidth: "44ch" }}>Один оператор закрывает и личную посылку, и регулярный импорт.</p></div>
            <div className="aud-split">
              <Reveal className="aud">
                <span className="aud__tag">Частным лицам</span>
                <h3>Покупки для себя и семьи</h3>
                <ul>
                  <li><IconCheck /><span>Доставка заказов из любимых зарубежных магазинов</span></li>
                  <li><IconCheck /><span>Бесплатная упаковка и бесплатный поиск товара</span></li>
                  <li><IconCheck /><span>Объединение нескольких посылок ради экономии</span></li>
                  <li><IconCheck /><span>Отслеживание в приложении, боте и на сайте</span></li>
                </ul>
                <a className="btn btn--ghost" href={CONTACT.telegram}>Оформить посылку</a>
              </Reveal>
              <Reveal className="aud aud--dark" delay={90}>
                <span className="aud__tag">Бизнесу</span>
                <h3>Импорт и поставки под ключ</h3>
                <ul>
                  <li><IconCheck /><span>Регулярные поставки от поставщиков из Китая и Турции</span></li>
                  <li><IconCheck /><span>Выкуп и закуп в России из компаний без ВЭД-отдела</span></li>
                  <li><IconCheck /><span>Консолидация партий и оптимизация стоимости килограмма</span></li>
                  <li><IconCheck /><span>Персональный менеджер и приоритетные сроки</span></li>
                </ul>
                <a className="btn btn--primary" href={CONTACT.telegram}>Обсудить поставки</a>
              </Reveal>
            </div>
          </div>
        </section>
        ...
        <section className="section" id="how">
          <div className="wrap">
            <div className="shead--edit">
              <span className="sidx">02 — Как это работает</span>
              <h2>Четыре шага до вашей двери</h2>
            </div>
            <div className="proc">
              {[
        ...
        <section className="section panel" id="faq">
          <div className="wrap faq-split">
            <div className="faq-aside">
              <span className="sidx">05 — Вопросы и доверие</span>
              <h2>Коротко о доставке и выкупе</h2>
              <p className="lead">Нам доверяют тысячи клиентов — вот реальные оценки.</p>
              <div className="ratings">
                {RATINGS.map((r) => (
                  <div key={r.src} className="rating">
                    <div className="rating__score">{r.score}<span>★</span></div>
                    <div className="rating__src">{r.src}</div>
                    <div className="rating__cnt">{r.count}</div>
                  </div>
                ))}
              </div>
            </div>
            <div className="faq-rows">
              {FAQ.map((f, i) => (
                <Reveal key={f.q} className="faq-qa" delay={i * 40}><h3>{f.q}</h3><p>{f.a}</p></Reveal>
              ))}
            </div>
          </div>
        </section>
        ...
        <section className="section" id="track">
          <div className="wrap" style={{ display: "grid", justifyItems: "center", gap: "1.2rem", textAlign: "center" }}>
            ...
            <p className="lead">Введите номер отправления — покажем актуальный статус и сроки.</p>
            <Tracking />
            <p className="muted">Ещё отследить можно в приложении Ethno Logistics и в Telegram-боте <a href={CONTACT.trackBot} style={{ color: "var(--accent)", fontWeight: 600 }}>@ethnologisticsbot</a></p>
            <div style={{ marginTop: "2rem", maxWidth: "62rem" }}>
              <p className="muted" style={{ marginBottom: "1rem" }}>Везём из тысяч магазинов — вот популярные:</p>
              <div className="stores">{STORES.map((s) => <span key={s} className="store">{s}</span>)}</div>
              <div style={{ marginTop: "1.6rem" }}>
                <Link className="btn btn--ghost" href="/stores">Все магазины и категории</Link>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="wrap">
            <div className="shead--edit" style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", flexWrap: "wrap", gap: "1rem" }}>
              <div className="shead--edit" style={{ margin: 0, gap: ".7rem" }}>
                <span className="sidx">06 — Гайды</span>
                <h2>Как заказывать выгодно и без ошибок</h2>
              </div>
              <Link className="btn btn--ghost" href="/blog">Все статьи</Link>
            </div>
            <div className="blog-feat">
              <Reveal as={Link} href={`/blog/${ARTICLES[0].slug}`} className="blog-main">
                ...
                <span className="blogcard__tag">{ARTICLES[0].tag}</span>
                <h3>{ARTICLES[0].title}</h3>
                <p>{ARTICLES[0].excerpt}</p>
                <span style={{ color: "rgba(255,255,255,.7)", fontSize: ".85rem", marginTop: ".8rem" }}>{ARTICLES[0].read} · читать</span>
              </Reveal>
              <div className="blog-side">
                {ARTICLES.slice(1).map((a, i) => (
                  <Reveal as={Link} key={a.slug} href={`/blog/${a.slug}`} className="blog-mini" delay={i * 80}>
                    ...
                    <h3>{a.title}</h3>
                    <p>{a.excerpt}</p>
                    <span className="muted" style={{ fontSize: ".82rem" }}>{a.read} · читать</span>
                  </Reveal>
                ))}
              </div>
            </div>
          ...
          <div className="wrap">
            <Reveal className="lead-block">
              <div className="lead-block__left">
                <span className="lead-pill">Бесплатный расчёт</span>
                <h2>Рассчитать доставку и выкуп</h2>
                <p className="lead-block__sub">Укажите, что и откуда везём — менеджер подберёт маршрут и посчитает стоимость. Ответ в течение 60 минут.</p>
                <div className="lead-mgr">
                  <span className="lead-mgr__av">E</span>
                  <div>
                    <div className="lead-mgr__n">Персональный менеджер Ethno</div>
                    <div className="lead-mgr__r">Ответ за 60 минут · {CONTACT.phone}</div>
                  </div>
                </div>
              </div>
              <LeadForm />
